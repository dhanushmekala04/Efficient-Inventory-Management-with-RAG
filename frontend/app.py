...
# FastAPI server URLs
FASTAPI_URL_FILES = "http://127.0.0.1:8080/upload-files/"
FASTAPI_URL_URLS = "http://127.0.0.1:8080/process-urls/"
FASTAPI_URL_QUERY = "http://127.0.0.1:8080/generate-response/"
